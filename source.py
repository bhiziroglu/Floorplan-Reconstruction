...
for pair in iter(S):
    ...
    if int(ends[0][0]) - int(ends[1][0]) == 0:
        ...
        for j in range(2):
            ...
            for wall in reduced_walls:
                ...
                for wall2 in reduced_walls:
                    ...
                    # Vertical ->
                    #             X values are same for corners of different walls
                    # Horizontal ->
                    #             Y values are same for corners of different walls

                    if corner1_X == corner3_X:  # Vertical collision
